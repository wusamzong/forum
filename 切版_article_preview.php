<?php foreach ($sql->fetchAll() as $row) {
    ...
    // 文章內容、讚數、回覆數、發文時間
    echo '<div class="col-12 row articalContentPreview border-bottom text-justify pt-3" onclick="window.location.href=' . "'切版_article_detail.php?ID=" . $ID . "'" . '">';
    echo '<p class="p-3">' . $content . '</p>';
    echo '</div>' . "\n";
    echo '<div class="col-12 row justify-content-between pt-2">' . "\n";
